...
createAcc.onclick=(event)=>{
    ...
    if(password.value && gender.value){
        if(validPassword(password.value)){
            ...
            fetch("http://localhost/draft/Twitter-clone-project/twitter frontend/js/valid-email.php",information)
            ...
            .then(data => {
                if (data.valid){
                    if(validPassword(password.value)){
                        ...
                        fetch("http://localhost/draft/Twitter-clone-project/twitter frontend/js/create.php",information)
                    }
                }
